...
#  are assumed to have the scene center at the origin of a cartersian        #
#  coordinate system (ECF, [lat,long,zenith], for example).                  #
#                                                                            #
#  If passing in data from an auxillary file, replace the definitions        #
#  below with expressions that translate the auxillary data labels           #
