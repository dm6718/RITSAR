...
To get started, first make sure your SciPy and NumPy libraries are up-to-date.  With Anaconda, this can be done by typing

$ conda update conda

$ conda update anaconda

from a terminal.  Once you've ensured the required libraries are up-to-date, download the zip file and extract it to a directory that will from here on be referred to as \<ritsar_dir\>.  Open up a command line or terminal and type:
